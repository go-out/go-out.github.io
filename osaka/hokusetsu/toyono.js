...
const hokusetsutoyono = {
    ...
    'features': [
        ...
        },
        {
            ...
            'featured': [
                ...
                },
                {
                    'title': null,
                    'month': [10],
                    'date': '豊中市の木「金木犀」やギンモクセイ、豊中市の花「薔薇」が秋の見頃を迎える',
                    'note': null,
                    'thisYear': null
                }
            ]
        ...
        },
        {
            ...
            'geometry': {
                'type': 'Point',
                'coordinates': [135.49302813793076, 34.8067071244533]
            },
            'properties': {
                'title': '千里ニュータウン',
        ...
        },
        {
            ...
            'geometry': {
                'type': 'Point',
                'coordinates': [135.42895483334058, 34.83119788979488]
            },
            'properties': {
                'title': '五月山公園',
            ...
            'featured': [
                {
                    'title': null,
                    'month': [5],
                    'date': '五月山周辺・城跡公園などで池田市の花「さつきつつじ」が見頃を迎える',
                    'note': null,
                    'thisYear': null
                },
                {
        ...
        },
        {
            ...
            'geometry': {
                'type': 'Point',
                'coordinates': [135.4405849758353, 34.817264407216896]
            },
            'properties': {
                'title': '水月公園',
            ...
            'featured': [
                {
                    'title': null,
                    'month': [6],
                    'date': '6月上旬、約60種6000株のハナショウブが見頃を迎える',
                    'note': null,
                    'thisYear': null
                }
            ]
